...
import {DrawerContentComponentProps, createDrawerNavigator, DrawerContent} from '@react-navigation/drawer';
import {useErrorHandler, useStartProfiler} from '@shopify/react-native-performance';
import {DrawerNavigationHelpers} from '@react-navigation/drawer/lib/typescript/src/types';

export const DEFAULT_SOURCE_NAME = 'Drawer';

type DrawerContentType = (props: DrawerContentComponentProps) => React.ReactNode;
...
function createProfiledDrawerContent({
  ...
  const ProfiledDrawerContent: DrawerContentType = ({navigation, ...rest}) => {
...
const createProfiledDrawerNavigator = <TParamList extends {[key: string]: {[key: string]: unknown} | undefined}>({
  ...
  const ProfiledNavigator: typeof BaseDrawer.Navigator = ({drawerContent = DrawerContent, ...rest}) => {
    ...
    return <BaseDrawer.Navigator {...rest} drawerContent={profiledDrawerContent} />;
  };
