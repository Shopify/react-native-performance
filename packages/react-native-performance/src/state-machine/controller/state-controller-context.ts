...
const StateControllerContext = React.createContext<StateController | undefined>(undefined);

export const StateControllerContextProvider = StateControllerContext.Provider;

export const useStateController = ({destinationScreen}: {destinationScreen?: string} = {}): StateController => {
