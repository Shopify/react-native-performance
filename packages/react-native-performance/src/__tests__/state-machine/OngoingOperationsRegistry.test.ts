import OngoingOperationsRegistry, {OperationNotStartedError} from '../../state-machine/OngoingOperationsRegistry';
...
describe('state-machine/OngoingOperationsRegistry', () => {
  ...
  it('throws an error if an unknown operation is completed', () => {
    expect(() => state.onOperationCompleted('some_screen', 'Query1')).toThrowError(OperationNotStartedError);
  });
