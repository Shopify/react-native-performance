...
export declare type OnStateChangedListener = (destinationScreen: string, oldState: State | undefined, newState: State) => void;
export declare type RenderTimeoutConfig = {
    enabled: true;
